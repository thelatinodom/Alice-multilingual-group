...
dire = it_nlp("dire")[0]._.wordnet.synsets()[0]
comparison1 = it_nlp("pensare")[0]._.wordnet.synsets()[0]

print("The Wu-Palmer similarity between 'dire' and 'pensare' is:",  dire.wup_similarity(comparison1))

re = it_nlp("re")[0]._.wordnet.synsets()[0]
comparison2 = it_nlp("bruco")[0]._.wordnet.synsets()[0]
...
decir = es_nlp("decir")[0]._.wordnet.synsets()[0]
comparison1 = es_nlp("pensar")[0]._.wordnet.synsets()[0]

print("The Wu-Palmer similarity between 'decir' and 'pensar' is:",  decir.wup_similarity(comparison1))

rey = es_nlp("rey")[0]._.wordnet.synsets()[0]
comparison2 = es_nlp("oruga")[0]._.wordnet.synsets()[0]
...
dire = fr_nlp("dire")[0]._.wordnet.synsets()[0]
comparison1 = fr_nlp("penser")[0]._.wordnet.synsets()[0]

print("The Wu-Palmer similarity between 'dire' and 'penser' is:",  dire.wup_similarity(comparison1))

roi = fr_nlp("roi")[0]._.wordnet.synsets()[0]
comparison2 = fr_nlp("chenille")[0]._.wordnet.synsets()[0]
